...
class ScschoolteacherController extends Controller
{
    ...
    public function getclassstudentsforqan(Request $request){

        $classstudents=User::where('usertype','student')
...
// createfromexcel
public function createfromexcelforqan(Request $request)
    {
        // return response()->json(['message' =>$request[0]]);
        ...
        $userdatatocreate=[
            ...
            'nameen'    =>$request[$i]['nameen'   ],
            'classname' =>$request[$i]['classname'],
            'subjects' =>$request[$i]['subjects'],
            'usertype'    =>'teacher',
            'project_name'    =>'forqan',
            'school_id'      =>Auth::user()->school_id,
    ...
    return response()->json(['message' => ' sucess   created '.count($datadb) ." students with:".$error_num."error" ]);



}//createfromexcelforqan---------------------------------------------------------------------------

public function createstudentsfromexcelforqan(Request $request)
    {
        // return response()->json(['message' =>$request[0]]);
