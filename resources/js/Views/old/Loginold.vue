...
export default {
    ...
    data() {
        return {
            ...
            identity: "",//identity
					username: "",//username
					password: "",//password
					verificationCode: "",//verification code, not used, no need to fill in
					rememberMe: true,//remember me, the default is to check
    ...
    mounted: function() {
					...
					//Get the cookie value when the page loads
					_this.getCookie();
				},
