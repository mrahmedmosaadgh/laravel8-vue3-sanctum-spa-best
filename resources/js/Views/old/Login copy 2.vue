...
<div  >
<div class=" ">
<!-- <div class="max-w-screen-md sm:w-20 mx-auto text-gray-900"> -->
    <!-- <div class="flex justify-center"> -->
        <div class="flex-1 sm:w-20 sm:bg-green-500 bg-yellow-500 w-full  lg:bg-red-600  md:bg-blue-600 text-gray-900">
        <!-- <div class="flex-1"> -->
            <div class="b-cover border w-auto">
...
<!-- <p v-if="this.$store.getters.user.usertype">user:{{this.$store.getters.user.usertype}}</p> -->
                    <form class="md:w-10/12 md:p-4 sm:w-full mx-auto" @submit.prevent="login">
                        <!-- <div class=" w-full my-1 py-2  flex   items-center  justify-between"> -->
                        <div class=" sm:w-full my-1 py-2 sm:flex  sm:items-center sm:justify-between">
...
export default {
    ...
    if (usertype=='siteadmin'  ) {alert('siteadmin'  )}
    if (usertype=='admin'  ) {alert('admin'  )}
    if (usertype=='teacher') {alert('teacher')}
    if (usertype=='student') {alert('student')}
    if (usertype=='parent' ) {alert('parent' )}
