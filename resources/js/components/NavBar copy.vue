    ...
    <div class="shadow-md bg-white ">
        <div class="max-w-screen-lg mx-auto flex justify-between">
            <div class=" p-4 ">
                ...
                <router-link active-class="font-semibold text-gray-900" v-if="user" class="px-6 text-gray-500 hover:text-gray-900 " :to="{ path: rn }">
                    back
                </router-link>
                <div class="dropdown ">
...
:class="(togTopnav)?'responsive':''"
 ...
 <li class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="#">
        <NavBarAdminMenu></NavBarAdminMenu>
      </a>
      <a href="#">
        <NavBarTeacherMenu></NavBarTeacherMenu>
      </a>
      <a href="#">
        <NavBarStudentMenu></NavBarStudentMenu>
      </a>
...
<div class="dropdown">
  ...
  <a href="#">Link 2</a>
  <a href="#">Link 3</a>
          <NavBarAdminMenu class="a"></NavBarAdminMenu>
        <NavBarTeacherMenu></NavBarTeacherMenu>
        <NavBarStudentMenu></NavBarStudentMenu>
  </div>
</div>
...
return{
    ...
    computed : {
      ...
      //                   this.rn =lastPath
      //                 }
      // // lastPath =lastPath ? lastPath : '/home'
      // return    lastPath  
      // return  { name: lastPath }
      // },
        user() {
...
.dropdown-content a:hover .a:hover{
