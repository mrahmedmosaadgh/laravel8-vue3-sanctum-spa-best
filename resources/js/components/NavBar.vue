<template>
  <div >
    <!-- NavBarNavBarNavBarNavBarNavBarNavBarNavBarNavBarNavBarNavBarNavBarNavBarNavBarNavBar -->
...
<g transform="translate(79,15.5)">
  ...
  <div class="nav-links  z-50 flex flex-row">
    ...
    <a v-if="user"  href="#">    <NavBarAdminMenu     v-if="user.project_name=='admin'"   ></NavBarAdminMenu></a>
    <a v-if="user"  href="#">    <NavBarTeacherMenu   v-if="user.usertype=='teacher'"   ></NavBarTeacherMenu></a>
    <a v-if="user"  href="#">    <NavBarStudentMenu   v-if="user.usertype=='student'"   ></NavBarStudentMenu></a>
     <!-- <a v-if="user" href="#">    <NavBarMarksMenu  v-if="user.project_name=='marks'" ></NavBarMarksMenu></a> -->
     <a href="#"  class="dropdown     "> 
    
    

  <div  v-if="$store.getters.isuser" class=" dropbtn">
    <div class="flex">
{{user.name}}

     <!-- <marquee Scrollamount=2 direction="left" class=" w-12">
...
class="avatar avatar-sm mr-12 ml-4"> -->
 </div>
  ...
  <div class="dropdown-content">
                     ...
                     <router-link
                      v-for="(rout,index) in myrouts" :key="index"
                      active-class=" font-semibold text-gray-900"
                       class="ar px-6 text-gray-500 hover:text-gray-900 " 
                       :to="rout.name">
                       {{rout.title}}
                     </router-link>

                    <router-link class="ar p-4 flex items-center" :to="{ name: 'settings' }">
