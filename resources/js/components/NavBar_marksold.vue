<template>
  <div >
    <!-- NavBar_marksNavBar_marksNavBar_marksNavBar_marksNavBar_marksNavBar_marksNavBar_marksNavBar_marksNavBar_marksNavBar_marksNavBar_marks -->
<div class="nav backgrad">


  <div class="nav-header">
    <div class="nav-title">
     <!-- SchoolEveryThing -->
<svg @click="$router.push('Home')" class=" cursor-pointer" xmlns="http://www.w3.org/2000/svg" style="margin: auto; display: block; shape-rendering: auto; background: none;" width="158"      height="31" preserveAspectRatio="xMidYMid">
...
<!-- </div> -->
                 ...
                 <!-- <router-link active-class="font-semibold text-gray-900" v-if="user" class="a px-6 text-gray-500 hover:text-gray-900 " 
                :to="{ name: 'uploadexcel' }">
                    uploadexcel
                </router-link> -->
...
<div class="dropdown mr-2 show">
		          <a class="nav-item nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="true">الخصائص والأدوات</a>
		          <div class="dropdown-menu dropdown-menu-right show" id="sub-menu" x-placement="bottom-end" style="position: absolute; transform: translate3d(-56px, 35px, 0px); top: 0px; left: 0px; will-change: transform;">

		          	

		          	
		            <a class="gtm-header-f-dc dropdown-item " href="/islamic-date-converter/?language=ar">محول التواريخ الإسلامية</a>

		            
		            <a class="gtm-header-f-qd dropdown-item " href="/Qibla-Direction/?language=ar">اتجاه القبلة</a>
		            
		            <a class="gtm-header-f-ifn dropdown-item " href="/news/?language=ar">الأخبار</a>

		            
		            <a class="gtm-header-f-h dropdown-item " href="/hadith/?language=ar">الحديث</a>

		            
		            <a class="gtm-header-f-kn dropdown-item " href="/knowledge/?language=ar">معرفة</a>

		            
		            <a class="gtm-header-f-ig dropdown-item " href="/islamic-gallery/?language=ar">المعرض الإسلامية</a>

		            
		            <a class="gtm-header-f-zac dropdown-item " href="/zakat-calculator/?language=ar">الزكاة حاسبة</a>

		            <a class="gtm-header-f-pw dropdown-item" href="/widgets/?language=ar">الأدوات الذكية للصلاة</a>

		            
		            <a class="gtm-header-f-pb dropdown-item " href="/prayerbook/?language=ar">سجل الصلوات</a>

		            
		            
		            	<a class="gtm-header-f-ip dropdown-item " href="/places/saudi-arabia-mecca/46541428/all/1/?language=ar">الأماكن الإسلامي</a>
					

					

					
		        	<a class="gtm-header-menu-aq smshow dropdown-item d-none " href="/quran/?language=ar">القرآن</a>

		        	
		        	<a class="gtm-header-menu-du smshow dropdown-item d-none " href="/duas/?language=ar">الدعاء</a>
...
import NavBarAdminMenu from './NavBar/NavBarAdminMenu.vue'
import NavBarTeacherMenu from './NavBar/NavBarTeacherMenu.vue'
import NavBarStudentMenu from './NavBar/NavBarStudentMenu.vue'
import NavBaruserMenu from './NavBar/NavBaruserMenu.vue'
import NavBarMarksMenu from './NavBar/NavBarMarksMenu.vue'
...
background: -moz-linear-gradient(0deg, rgba(9,9,121,0.8855917366946778) 35%, rgba(0,212,255,1) 100%);
background: -webkit-linear-gradient(0deg, rgba(9,9,121,0.8855917366946778) 35%, rgba(0,212,255,1) 100%);
background: linear-gradient(0deg, rgba(9,9,121,0.8855917366946778) 35%, rgba(0,212,255,1) 100%);
